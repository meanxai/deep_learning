...
#
from tensorflow.keras.layers import Dense, Input, SimpleRNN, TimeDistributed
...
for i in range(n_future):
    ...
    # Predict the next value. In the prediction stage, only the output
    # of the final time step is used.

# [MXDL-1-05] 3.binary_single_layer.py
#
...
#
# Create an single-layered ANN model and perform binary 
...
# Create single-layered ANN model
...
def predict(x, proba=True):
    p = parameters
    o_output = sigmoid(np.dot(x, p[0]) + p[1])  # output from output layer
